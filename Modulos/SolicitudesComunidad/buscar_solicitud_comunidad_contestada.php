	...
	<div align="center">
    	<table width="90%">
          <tr>
			...
			<?php
			echo $buscaCod_contestada=$_POST['cod_contestada'];
			$id_contestada=$buscaCod_contestada;
                ...
                <table class="table table-bordered">
				  ...
				  <?php 
				  	if(!empty($_POST['buscar'])){
						...
						$pame=mysql_query("SELECT * FROM solicitudescomunidad WHERE cod_radicado and (cod_radicado='$buscar' or contestada LIKE '%$buscar%') ORDER BY cod_radicado DESC");	
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";

					}else{
						$pame=mysql_query("SELECT * FROM solicitudescomunidad WHERE contestada=$buscaCod_contestada ORDER BY fecha_solicitud DESC");		
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";
					}		
