    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="right">
			<form method="POST" action="crear_estrategia4.php">
				<?php
				...
				echo "</tr>";
				echo "<tr>";
				$consultaestrategia=mysql_query("SELECT MAX(cod_estrategia) AS ultimoEstrategia FROM plandedesarrolloestrategia");
					while($filaestrategia=mysql_fetch_array($consultaestrategia)){
						$nuevoCod_estrategia=$filaestrategia['ultimoEstrategia']+1;
						echo '<td>Codigo Politica: </td><td><input type="text" name="cod_estrategia" readonly value="'.$nuevoCod_estrategia.'"></td>';
					}

				echo "<td>";
					?>
				<strong>Escriba una Politica: </strong>
				</td>
				<td>
				<input type="text" name="estrategia">
                    ...
                    <input type="submit" value="Crear Politica >>">
			</form>
