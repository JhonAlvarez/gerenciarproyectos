          ...
          <tr>
            <td>
            	<table class="table table-bordered">
                  <tr class="well">
                    <td>
                    	<h2 align="center">Politica creada con exito</h2>
                    </td>
                  </tr>
                </table>
                <div align="right">
<form method="POST" action="crear_estrategia.php">
				<?php
				...
				$consultaestrategia=mysql_query("SELECT * FROM plandedesarrolloestrategia WHERE cod_estrategia=$cod_estrategia and cod_eje=$cod_eje");
		...
		<td>
                    <input type="submit" value="Crear Nueva Politica >>">
		</td>
		</tr>
		<table>
</form>
