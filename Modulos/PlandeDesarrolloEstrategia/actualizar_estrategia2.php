	...
	<div align="center">
    	<table width="90%">
          <tr>
            <td>
		<?php
		mysql_query("UPDATE plandedesarrolloestrategia SET estrategia='$estrategia' WHERE cod_plan='$cod_plan' AND cod_eje='$cod_eje' AND cod_estrategia='$cod_estrategia' ");
		...
		?>
			...
			<br>
                    Politica <br>
		  	<input type="text" name="estrategia" autocomplete="off" required readonly value="<?php echo $estrategia; ?>">
			<br>
