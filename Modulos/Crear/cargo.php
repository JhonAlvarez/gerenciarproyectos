	...
	<div align="center">
    	<table width="90%">
          <tr>
		    ...
		    <form method="POST" action="cargo2.php">
			<?php
				$consultaCod_cargo=mysql_query("SELECT MAX(cod_cargo) AS ultimoCargo FROM cargos");
					while($filacargo=mysql_fetch_array($consultaCod_cargo)){
						$nuevoCod_cargo=$filacargo['ultimoCargo']+1;
						echo '<input type="text" name="cod_cargo" readonly value="'.$nuevoCod_cargo.'">';
					}
			?>
