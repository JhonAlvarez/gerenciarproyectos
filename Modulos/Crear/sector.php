	...
	<div align="center">
    	<table width="90%">
          <tr>
		    ...
		    <form method="POST" action="sector2.php">
			<?php
				$consultaCod_sector=mysql_query("SELECT MAX(cod_sector) AS ultimoSector FROM sectores");
					while($filasector=mysql_fetch_array($consultaCod_sector)){
						$nuevoCod_sector=$filasector['ultimoSector']+1;
						echo '<input type="text" name="cod_sector" readonly value="'.$nuevoCod_sector.'">';
					}
			?>
