...
<html lang="es">
  ...
  <body>
	...
	<div align="center">
          ...
          <tr>
            <td>
            	<table class="table table-bordered">
                  <tr class="well">
                    <td>
                    	<h2 align="center">Crear Momento Estructuracion</h2>
                    </td>
                  </tr>
                </table>
                <div align="center">
		...
		$consultaInsertarCod_momentoestructuracion=mysql_query("SELECT * FROM momentos WHERE cod_momento='$cod_momento' ");
		if($row=mysql_fetch_array($consultaInsertarCod_momentoestructuracion)){
			echo mensajes('Este momento ya existe','rojo');
		}else{
			echo mensajes('Este momento fue agragado exitosamente','verde');
			mysql_query("INSERT INTO momentos (cod_momento, momento) VALUES ('$cod_momento', '$momento')");
		...
		?>
			...
			<h3 align='center'>Momento Estructuracion</h3>
