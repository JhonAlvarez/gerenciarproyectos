    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="right">
                    <a href="#nuevo" role="button" class="btn" data-toggle="modal"><strong>Crear Plan de Desarrollo</strong></a>
                </div>
                ...
                <div id="nuevo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-header">
	                    ...
	                    <h3 id="myModalLabel">Crear Plan de Desarrollo</h3>
                    </div>
			...
			if (mysql_num_rows($resultado)>0){
                ...
                <table class="table table-bordered table table-hover">
                  ...
                  <?php }}else{ 
					  $pa=mysql_query("SELECT * FROM plandedesarrollo ORDER BY cod_plan DESC");				
						while($row=mysql_fetch_array($pa)){
				  ?>
                  <tr>
