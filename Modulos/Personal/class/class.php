...
class Proceso_Personal{
	...
	function __construct($Cedula, $Nombres, $Apellidos, $Dependencia, $Observaciones, $Celular, $Cargo, $Profesion, $Especializacion, $Email){
		$this->Cedula=$Cedula;
	...
	function crear(){
		...
		mysql_query("INSERT INTO personal (Cedula, Nombres, Apellidos, Dependencia, Observaciones, Celular, Cargo, Profesion, Especializacion, Email) VALUES ('$Cedula','$Nombres','$Apellidos', '$Dependencia', '$Observaciones', '$Celular','$Cargo','$Profesion','$Especializacion','$Email')");
	}
	...
	function actualizar(){
		...
		mysql_query("UPDATE personal SET Nombres='$Nombres', Apellidos='$Apellidos', Dependencia='$Dependencia', Observaciones='$Observaciones', Celular='$Celular', Cargo='$Cargo', Profesion='$Profesion', Especializacion='$Especializacion', Email='$Email' WHERE Cedula='$Cedula'");
	}
}
