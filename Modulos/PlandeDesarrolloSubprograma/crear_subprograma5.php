...
<html lang="es">
  ...
  <body>
    ...
    <?php include_once "../../menu/m_plandedesarrollosubprograma.php"; ?>
          ...
          <tr>
            <td>
            	<table class="table table-bordered">
                  <tr class="well">
                    <td>
                    	<h2 align="center">Crear Subprograma</h2>
                    </td>
                  </tr>
                </table>
                <div align="right">
			<form method="POST" action="crear_subprograma6.php">
				<?php
				...
				echo "</tr>";
				echo "<tr>";
				$consultasubprograma=mysql_query("SELECT MAX(cod_subprograma) AS ultimoSubprograma FROM plandedesarrollosubprograma");
					while($filasubprograma=mysql_fetch_array($consultasubprograma)){
						$nuevoCod_subprograma=$filasubprograma['ultimoSubprograma']+1;
						echo '<td>Codigo Subprograma: </td><td><input type="text" name="cod_subprograma" readonly value="'.$nuevoCod_subprograma.'"></td>';
					}


					?>
				<td>
				<strong>Escriba el Nombre del Subprograma: </strong>
				</td>
				<td>
				<input type="text" name="subprograma">
				</td>
				</tr>
				</table>
                    <input type="submit" value="Crear Subprograma >>">
			</form>
