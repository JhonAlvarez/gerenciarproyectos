    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="right">
			<form method="POST" action="crear_subprograma4.php">
				<?php
				...
				echo "<td>";
					?>
				<strong>Elija una Politica</strong>
				</td>
				<td>
                                  <select name="cod_estrategia" class="input-xlarge">
					<?php
					$consultaestrategia2=mysql_query("SELECT * FROM plandedesarrolloestrategia WHERE cod_plan=$cod_plan and cod_eje=$cod_eje");
					while($fila2=mysql_fetch_array($consultaestrategia2)){
						echo '<option value="'.$fila2['cod_estrategia'].'">'.$fila2['estrategia'].'</option>';
					}
