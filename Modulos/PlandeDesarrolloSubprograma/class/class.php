<?php
class Proceso_PlandeDesarrolloSubprograma{
	var $cod_subprograma;
	var $subprograma;
	var $cod_programa;
	var $cod_estrategia;
	...
	function __construct($cod_subprograma, $subprograma, $cod_programa, $cod_estrategia, $cod_eje, $cod_plan){
	...
	function crear(){
		...
		mysql_query("INSERT INTO plandedesarrollosubprograma (cod_subprograma, subprograma, cod_programa, cod_estrategia, cod_eje, cod_plan) VALUES ('$cod_subprograma', '$subprograma', '$cod_programa', '$cod_estrategia', '$cod_eje', '$cod_plan')");
	}
	...
	function actualizar(){
		...
		mysql_query("UPDATE plandedesarrollosubprograma SET subprograma='$subprograma', cod_programa='$cod_programa', cod_estrategia='$cod_estrategia', cod_eje='$cod_eje', cod_plan='$cod_plan' WHERE cod_subprograma='$cod_subprograma'");
	}
}
