...
<html lang="es">
  ...
  <body>
	...
	<div align="center">
		...
		<form method="POST" action="licitacion3.php">
		<table>
		  <tr>
		    <td>
		  ...
		  <tr>
		    ...
		    <td>
			<?php
				$consultalicitacion=mysql_query("SELECT MAX(cod_licitacion) AS ultimaLicitacion FROM licitaciones");
					while($filalicitacion=mysql_fetch_array($consultalicitacion)){
						$nuevoCod_licitacion=$filalicitacion['ultimaLicitacion']+1;
						echo '<input type="text" name="cod_licitacion" readonly value="'.$nuevoCod_licitacion.'">';
					}
			?>

		    </td>
		    <td>
			<input type="text" name="fecha_licitacion">
		    </td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <td>
			<strong>Fecha Fin Licitacion (aaaa-mm-dd)</strong>
		    </td>
		    <td>
		  ...
		  <tr>
		    <td>
                                  <select name="cod_momentolicitacion">
					<?php
					$consultamomentolicitacion=mysql_query("SELECT * FROM momentoslicitaciones");
					while($filamomentolicitacion=mysql_fetch_array($consultamomentolicitacion)){
						echo '<option value="'.$filamomentolicitacion['cod_momentolicitacion'].'">'.$filamomentolicitacion['cod_momentolicitacion'].' '.$filamomentolicitacion['momentolicitacion'].'</option>';
					}
					?>
                                  </select>
		    ...
		    <td>
			<input type="text" name="fecha_licitacion_final">
		    </td>
...
<hr>
		...
		<table border="1">
		  <tr>
		    ...
		    <td>
			<strong>Fecha Licitacion</strong>
		    </td>
		    <td>
			<strong>Momento Licitacion</strong>
		    </td>
			...
			<form method="POST" action="cargar_archivo_licitacion.php">
			<?php
			...
			?>
                    ...
                    <td>
                    	<center>
			<?php echo $filalicitacion['cod_licitacion']; ?>
                            <a href="#act<?php echo $filalicitacion['cod_licitacion']; ?>" role="button" class="btn btn-mini" data-toggle="modal">
                                <i class="icon-edit"></i>
                            </a>
			
                            <a href="#eli<?php echo $filalicitacion['cod_licitacion']; ?>" role="button" class="btn btn-mini" data-toggle="modal">
...
<!--Ventana Editar comienza aqui-->
                  ...
                  <div id="act<?php echo $filalicitacion['cod_licitacion']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                	<form name="form2" method="post" action="actualizar_licitacion.php">
                    <input type="hidden" name="cod_licitacion" value="<?php echo $filalicitacion['cod_licitacion']; ?>">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                        <h3 id="myModalLabel">Editar Licitacion</h3>
                    </div>
                    <div class="modal-body">
                        <div class="row-fluid">
                            <div class="span6">
                                <strong>Codigo Proyecto</strong><br>
                                <input type="text" name="cod_proyecto" autocomplete="off" required readonly value="<?php echo $filalicitacion['cod_proyecto']; ?>"><br>

                                <strong>Codigo Licitacion</strong><br>
                                <input type="text" name="cod_licitacion" autocomplete="off" required readonly value="<?php echo $filalicitacion['cod_licitacion']; ?>"><br>

                                <strong>Momento Licitacion</strong><br>
                                  <select name="momento_licitacion">
					<?php
					$paLicitacion=mysql_query("SELECT * FROM momentoslicitaciones");
					while($filae=mysql_fetch_array($paLicitacion)){
						if($filae['cod_momentolicitacion']==$filalicitacion['momento_licitacion']){
							echo '<option value="'.$filae['cod_momentolicitacion'].'" selected>'.$filae['cod_momentolicitacion'].' '.$filae['momentolicitacion'].'</option>';
						}else{
							echo '<option value="'.$filae['cod_momentolicitacion'].'">'.$filae['cod_momentolicitacion'].' '.$filae['momentolicitacion'].'</option>';	
						}
					}
					?>
                                  </select><br>
                                ...
                                <input type="text" name="fecha_licitacion" autocomplete="off" value="<?php echo $filalicitacion['fecha_licitacion']; ?>"><br>

                                <strong>Fecha</strong><br>
                                <input type="text" name="fecha_licitacion_final" autocomplete="off" value="<?php echo $filalicitacion['fecha_licitacion_final']; ?>"><br>

                                <strong>Observaciones</strong><br>
                                <input type="text" name="observaciones" autocomplete="off" value="<?php echo $filalicitacion['observaciones']; ?>"><br>
...
<!--Aqui comienza la ventana Eliminar-->
                  ...
                  <div id="eli<?php echo $filalicitacion['cod_licitacion']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                	<form name="form3" method="post" action="eliminar_licitacion.php">
	                    <input type="hidden" name="cod_licitacion" value="<?php echo $filalicitacion['cod_licitacion']; ?>">
	                    <div class="modal-header">
        	                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                	        <h3 id="myModalLabel">Eliminar Licitacion</h3>
