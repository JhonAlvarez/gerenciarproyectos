    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="center">
			<strong>Buscar por Sector de Inversion: </strong>

			<?php

			echo $buscaCod_sectordeinversion=$_POST['cod_sectordeinversion'];

			$id_sectordeinversion=$buscaCod_sectordeinversion;
                ...
                <table class="table table-bordered">
				  ...
				  <?php 
				  	if(!empty($_POST['buscar'])){
						...
						$pame=mysql_query("SELECT * FROM proyectos WHERE cod_proyecto and (cod_proyecto='$buscar' or sectordeinversion LIKE '%$buscar%') ORDER BY cod_proyecto DESC");	
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";

					}else{
						$pame=mysql_query("SELECT * FROM proyectos WHERE sectordeinversion=$buscaCod_sectordeinversion ORDER BY cod_proyecto DESC");		
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";
