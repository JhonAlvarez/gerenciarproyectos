    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="center">
<?php
echo "Identificacion del Supervisor: ".$cedula_supervisor=$_SESSION['cod_user']."<br>";
?>

                            	<strong>Elija el Proyecto a Liquidacion</strong><br>
			<form method="POST" action="liquidacion2_supervisor.php">
                                  <select name="cod_proyecto" class="input-xlarge">
					<?php
					$consultacod_proyecto=mysql_query("SELECT * FROM proyectos WHERE supervisor='$cedula_supervisor' ORDER BY cod_proyecto DESC");
