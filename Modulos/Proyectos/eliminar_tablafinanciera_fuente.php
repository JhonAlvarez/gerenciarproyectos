	...
	<div align="center">
    	<table width="90%">
          <tr>
            <td>
		<?php
		mysql_query("DELETE FROM fuentesporproyectos WHERE cod_proyecto='$cod_proyecto' ");

		$q=mysql_query("SELECT * FROM fuentesporproyectos WHERE cod_proyecto='$cod_proyecto' ");
		if(mysql_num_rows($q) == 0){
			echo mensajes('El registro '.$cod_proyecto.' Ha sido Eliminado','verde');
		}else{
			echo mensajes('El registro '.$cod_proyecto.' no se elimino','rojo');
		}
