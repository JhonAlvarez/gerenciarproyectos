	...
	<div align="center">
    	<table width="90%">
          <tr>
            <td>
		<?php
		mysql_query("UPDATE estructuracion SET cod_proyecto='$cod_proyecto', cod_estructuracion='$cod_estructuracion', momento='$momento', fecha_estructuracion='$fecha_estructuracion', observaciones='$observaciones' WHERE cod_proyecto='$cod_proyecto' AND cod_estructuracion='$cod_estructuracion' ");
