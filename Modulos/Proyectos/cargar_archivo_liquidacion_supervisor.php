...
<?php
echo $cod_liquidacion=$_POST['cod_liquidacion'];
...
if(isset($_POST['boton'])){
	...
	if(in_array($ext, $formatos)){
		if(move_uploaded_file($nombreTmpArchivo, "../../archivos_liquidacion/".$cod_liquidacion.".pdf")){
			echo mensajes('Archivo subido','verde');
			echo '<a href="liquidacion_supervisor.php" role="button" class="btn" data-toggle="modal"><strong>Volver</strong></a>';
			exit();
		}else{
...
<input type="text" name="cod_liquidacion" readonly value="<?php echo $cod_liquidacion; ?>">
<br>
