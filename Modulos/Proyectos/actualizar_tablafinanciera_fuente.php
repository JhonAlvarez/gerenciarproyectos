	...
	<div align="center">
    	<table width="90%">
          <tr>
            <td>
		<?php
		mysql_query("UPDATE fuentesporproyectos SET cod_proyecto='$cod_proyecto', cod_fuentedefinanciacion='$cod_fuentedefinanciacion' WHERE cod_proyecto='$cod_proyecto' ");
