	...
	<div align="center">
    	<table width="90%">
          <tr>
			...
			echo $buscaCod_supervisor=$_POST['cod_supervisor'];

			$id_supervisor=$buscaCod_supervisor;
                ...
                <table class="table table-bordered">
				  ...
				  <?php 
				  	if(!empty($_POST['buscar'])){
						...
						$pame=mysql_query("SELECT * FROM proyectos WHERE cod_proyecto and (cod_proyecto='$buscar' or supervisor LIKE '%$buscar%') ORDER BY cod_proyecto DESC");	
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";

					}else{
						$pame=mysql_query("SELECT * FROM proyectos WHERE supervisor=$buscaCod_supervisor ORDER BY cod_proyecto DESC");		
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";
