...
<?php
echo $cod_ejecucion=$_POST['cod_ejecucion'];
...
if(isset($_POST['boton'])){
	...
	if(in_array($ext, $formatos)){
		if(move_uploaded_file($nombreTmpArchivo, "../../archivos_ejecucion/".$cod_ejecucion.".pdf")){
			echo mensajes('Archivo subido','verde');
			echo '<a href="ejecucion_supervisor.php" role="button" class="btn" data-toggle="modal"><strong>Volver</strong></a>';
			exit();
		}else{
...
<input type="text" name="cod_ejecucion" readonly value="<?php echo $cod_ejecucion; ?>">
<br>
