...
<?php
echo $cod_tablafinanciera=$_POST['cod_tablafinanciera'];
...
if(isset($_POST['boton'])){
	...
	if(in_array($ext, $formatos)){
		if(move_uploaded_file($nombreTmpArchivo, "../../archivos_tablafinanciera/".$cod_tablafinanciera.".pdf")){
			echo mensajes('Archivo subido','verde');
			echo '<a href="tablafinanciera_supervisor.php" role="button" class="btn" data-toggle="modal"><strong>Volver</strong></a>';
			exit();
		}else{
...
<input type="text" name="cod_tablafinanciera" readonly value="<?php echo $cod_tablafinanciera; ?>">
<br>
