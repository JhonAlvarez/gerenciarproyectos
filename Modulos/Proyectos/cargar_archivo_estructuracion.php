...
if(isset($_POST['boton'])){
	...
	if(in_array($ext, $formatos)){
		if(move_uploaded_file($nombreTmpArchivo, "../../archivos_estructuracion/".$cod_estructuracion.".pdf")){
			echo mensajes('Archivo subido','verde');
			echo '<a href="estructuracion.php" role="button" class="btn" data-toggle="modal"><strong>Volver</strong></a>';
			exit();
		}else{
