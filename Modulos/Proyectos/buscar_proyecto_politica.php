	...
	<div align="center">
    	<table width="90%">
          <tr>
			...
			echo $buscaCod_politica=$_POST['cod_politica'];

			$id_politica=$buscaCod_politica;

				$consultapolitica=mysql_query("SELECT * FROM estrategiadelproyecto WHERE cod_estrategiadelproyecto=$id_politica");

					while($filapolitica=mysql_fetch_array($consultapolitica)){

						echo " - ".$filapolitica['estrategiadelproyecto'];
                ...
                <table class="table table-bordered">
				  ...
				  <?php 
				  	if(!empty($_POST['buscar'])){
						...
						$pame=mysql_query("SELECT * FROM proyectos WHERE cod_proyecto and (cod_proyecto='$buscar' or estrategia LIKE '%$buscar%') ORDER BY cod_proyecto DESC");	
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";

					}else{
						$pame=mysql_query("SELECT * FROM proyectos WHERE estrategia=$buscaCod_politica ORDER BY cod_proyecto DESC");		
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";
                  ...
                  <tr>
                    <td>
					 ...
					 <a href="#act<?php echo $row['cod_proyecto']; ?>" data-toggle="modal">                     <?php echo $row['cod_proyecto']; ?>
