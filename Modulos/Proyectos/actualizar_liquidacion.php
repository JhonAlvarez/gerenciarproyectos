...
$momento_liquidacion=$_POST['momento_liquidacion'];
	...
	<div align="center">
    	<table width="90%">
          <tr>
            <td>
		<?php
		mysql_query("UPDATE liquidaciones SET cod_proyecto='$cod_proyecto', cod_liquidacion='$cod_liquidacion', momento_liquidacion='$momento_liquidacion', fecha_liquidacion='$fecha_liquidacion', fecha_liquidacion_final='$fecha_liquidacion_final', observaciones='$observaciones' WHERE cod_proyecto='$cod_proyecto' AND cod_liquidacion='$cod_liquidacion' ");
