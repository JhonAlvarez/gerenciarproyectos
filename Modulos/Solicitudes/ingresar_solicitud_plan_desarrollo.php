	...
	<div align="center">
    	...
    	<table width="70%">
          ...
          <tr>
           ...
           <input type="text" name="objetivoyubicacion" autocomplete="off" required style="WIDTH: 228px; HEIGHT: 98px" ><br>
                            ...
                            <div class="span6">
                                ...
                                <input type="text" name="afectacion" autocomplete="off" style="WIDTH: 228px; HEIGHT: 98px" ><br>
