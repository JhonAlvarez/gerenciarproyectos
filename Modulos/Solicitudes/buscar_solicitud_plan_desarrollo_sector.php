	...
	<div align="center">
    	<table width="90%">
          <tr>
			...
			<?php
			echo $buscaCod_sector=$_POST['cod_sector'];
			$id_sector=$buscaCod_sector;
			...
			?>
	                <a href="listado_solicitud_plan_desarrollo.php"><strong>Nueva Busqueda</strong></a>
                ...
                <table class="table table-bordered">
				  ...
				  <?php 
				  	...
				  	if(!empty($_POST['buscar'])){
						...
						$pame=mysql_query("SELECT * FROM solicitudesplandedesarrollo WHERE cod_solicitudplan and (cod_solicitudplan='$buscar' or sectordelproyecto LIKE '%$buscar%') ORDER BY cod_solicitudplan DESC");	
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";

					}else{
						$pame=mysql_query("SELECT * FROM solicitudesplandedesarrollo WHERE sectordelproyecto=$buscaCod_sector ORDER BY cod_solicitudplan DESC");		
						/* determinar el número de filas del resultado */
						$cantRegistros=mysql_num_rows($pame);
						echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>Se encontraron ".$cantRegistros." registros</strong>";
				  ...
				  ?>
                  <tr>
                    <td> <a data-toggle="modal" href="#act<?php echo $row['cod_solicitudplan']; ?>">  <?php echo $row['cod_solicitudplan']; ?>
