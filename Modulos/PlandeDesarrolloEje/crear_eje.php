    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="right">
                    <a href="#nuevo" role="button" class="btn" data-toggle="modal"><strong>Crear Eje</strong></a>
                </div>
                ...
                <div id="nuevo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-header">
	                    ...
	                    <h3 id="myModalLabel">Crear Eje</h3>
                    </div>
			...
			if (mysql_num_rows($resultado)>0){
                ...
                <table class="table table-bordered table table-hover">
                  <tr class="well">
                    ...
                    <td><strong>Nombre del Eje</strong></td>
                  </tr>
                  <?php
					if($existe==TRUE){				  				  	
                  ...
                  <?php }}else{ 
					  $pa=mysql_query("SELECT * FROM plandedesarrolloeje ORDER BY cod_eje DESC");				
						while($row=mysql_fetch_array($pa)){
				  ?>
                  <tr>
