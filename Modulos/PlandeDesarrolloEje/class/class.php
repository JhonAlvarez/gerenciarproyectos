<?php
class Proceso_PlandeDesarrolloEje{
	var $cod_eje;
	var $eje;
	var $cod_plan;


	function __construct($cod_eje, $eje, $cod_plan){
	...
	function crear(){
		...
		mysql_query("INSERT INTO plandedesarrolloeje (cod_eje, eje, cod_plan) VALUES ('$cod_eje', '$eje', '$cod_plan')");
	}
	...
	function actualizar(){
		...
		mysql_query("UPDATE plandedesarrolloeje SET eje='$eje', cod_plan='$cod_plan' WHERE cod_eje='$cod_eje'");
	}
}
