...
class Proceso_Cliente{
	...
	function crear(){
		...
		mysql_query("INSERT INTO clientes (doc, nom, ape, fecha, tel, cel, sexo, dir, nota, fechar, estado, clase, correo) VALUES ('$doc','$nom','$ape','$fecha','$tel','$cel','$sexo','$dir','$nota','$fechar','$estado','cliente','$correo')");
		mysql_query("INSERT INTO tbl_cupo (doc, cupo) value ('$doc','$cupo')");
	}
	...
	function actualizar(){
		...
		mysql_query("UPDATE clientes SET nom='$nom', ape='$ape', fecha='$fecha', tel='$tel', cel='$cel', sexo='$sexo', dir='$dir', nota='$nota', estado='$estado' WHERE doc='$doc'");
		mysql_query("UPDATE tbl_cupo SET cupo='$cupo' WHERE doc='$doc'");
	}
}
?>