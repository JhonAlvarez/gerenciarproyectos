    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="right">
			<form method="POST" action="crear_programa5.php">
				<?php
				...
				echo "</tr>";
				echo "<tr>";
				$consultaprograma=mysql_query("SELECT MAX(cod_programa) AS ultimoPrograma FROM plandedesarrolloprograma");
					while($filaprograma=mysql_fetch_array($consultaprograma)){
						$nuevoCod_programa=$filaprograma['ultimoPrograma']+1;
						echo '<td>Codigo Programa: </td><td><input type="text" name="cod_programa" readonly value="'.$nuevoCod_programa.'"></td>';
					}

				echo "<td>";
					?>
				<strong>Escriba el Nombre del Programa: </strong>
				</td>
				<td>
