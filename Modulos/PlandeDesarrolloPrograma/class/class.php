<?php
class Proceso_PlandeDesarrolloPrograma{
	var $cod_programa;
	var $programa;
	var $cod_estrategia;
	var $cod_eje;
	...
	function __construct($cod_programa, $programa, $cod_estrategia, $cod_eje, $cod_plan){
	...
	function actualizar(){
		...
		mysql_query("UPDATE plandedesarrolloprograma SET programa='$programa', cod_estrategia='$cod_estrategia', cod_eje='$cod_eje', cod_plan='$cod_plan' WHERE cod_programa='$cod_programa'");
	}
}
