    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="right">
			<form method="POST" action="crear_meta6.php">
				<?php
				...
				?>
				<td>
				<strong>Elija un Subprograma</strong>
				</td>
				<td>
                                  <select name="cod_subprograma" class="input-xlarge">
					<?php
					$consultasubprograma2=mysql_query("SELECT * FROM plandedesarrollosubprograma WHERE cod_plan=$cod_plan and cod_eje=$cod_eje and cod_estrategia=$cod_estrategia and cod_programa=$cod_programa");
					while($filasubprograma2=mysql_fetch_array($consultasubprograma2)){
						echo '<option value="'.$filasubprograma2['cod_subprograma'].'">'.$filasubprograma2['subprograma'].'</option>';
					}
