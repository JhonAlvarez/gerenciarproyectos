<?php
class Proceso_PlandeDesarrolloMeta{
	var $cod_meta;
	var $meta;
	var $cod_subprograma;
	var $cod_programa;
	...
	function __construct($cod_meta, $meta, $cod_subprograma, $cod_programa, $cod_estrategia, $cod_eje, $cod_plan){
	...
	function crear(){
		$cod_meta=$this->cod_meta;
		$meta=$this->meta;
		$cod_subprograma=$this->cod_subprograma;
	...
	function actualizar(){
		...
		mysql_query("UPDATE plandedesarrollometa SET meta='$meta', cod_subprograma='$cod_subprograma', cod_programa='$cod_programa', cod_estrategia='$cod_estrategia', cod_eje='$cod_eje', cod_plan='$cod_plan' WHERE cod_meta='$cod_meta'");
	}
}
