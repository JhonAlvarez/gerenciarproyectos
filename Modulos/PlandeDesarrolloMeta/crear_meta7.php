          ...
          <tr>
            <td>
            	<table class="table table-bordered">
                  <tr class="well">
                    <td>
                    	<h2 align="center">Meta creada con exito</h2>
                    </td>
                  </tr>
                </table>
                <div align="right">
<form method="POST" action="crear_meta.php">
				<?php
				...
				mysql_query("INSERT INTO plandedesarrollometa (cod_meta, meta, cod_subprograma, cod_programa, cod_estrategia, cod_eje, cod_plan) VALUES ('$cod_meta', '$meta', '$cod_subprograma', '$cod_programa',  '$cod_estrategia', '$cod_eje', '$cod_plan')");
				echo "<table>";
				echo "<tr>";
				...
				echo "</tr>";
				echo "<tr>";
				echo "<td>Codigo Meta: </td>";
				echo "<td><input type='text' name='cod_meta' readonly value='".$cod_meta."'></td>";
				$consultameta=mysql_query("SELECT * FROM plandedesarrollometa WHERE cod_meta=$cod_meta and cod_subprograma=$cod_subprograma and cod_programa=$cod_programa and cod_estrategia=$cod_estrategia and cod_eje=$cod_eje and cod_plan=$cod_plan");
					while($filameta=mysql_fetch_array($consultameta)){
						echo '<td>Meta: </td><td><input type="text" name="meta" readonly value="'.$filameta['meta'].'"></td>';
					}

				?>
		</tr>
		<td>
                    <input type="submit" value="Crear Nueva Meta >>">
		</td>
		</tr>
		<table>
</form>
