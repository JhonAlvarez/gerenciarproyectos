<div class="navbar navbar-inverse navbar-fixed-top">
            ...
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                    ...
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="crear_personal_supervisor.php"><i class="icon-plus"></i> Crear Personal</a>
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="listado_personal_supervisor.php"><i class="icon-list"></i> Listado del Personal</a>
 ...
 <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="../Proyectos/listado_proyecto_supervisor.php"><i class="icon-list"></i> Listado de Proyectos</a></li>
                    <li><a href="../Proyectos/estructuracion_supervisor.php"><i class="icon-plus"></i> Estructuracion</a></li>
