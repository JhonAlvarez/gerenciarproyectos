            ...
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                	<li role="presentation"><a role="menuitem" tabindex="-1" href="crear_estrategia.php"><i class="icon-plus"></i> Crear Politicas</a>
                    	</li>
                    	<li role="presentation"><a role="menuitem" tabindex="-1" href="listado_estrategia.php"><i class="icon-list"></i> Listado de Politicas</a>
                    	</li>
                </ul>
              </li> 
