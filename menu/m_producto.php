      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
			...
			<li role="presentation"><a role="menuitem" tabindex="-1" href="crear_producto.php"><i class="icon-plus"></i> Crear Producto</a></li>
			<li role="presentation"><a role="menuitem" tabindex="-1" href="listado_producto.php"><i class="icon-list"></i> Listado de Productos</a></li>
			<li><a href="estado_inventario.php"><i class="icon-list-alt"></i> Estado del Inventario</a></li>
			<li><a href="#"><i class="icon-shopping-cart"></i> Realizar Compras</a></li>
                </ul>
              </li> 
