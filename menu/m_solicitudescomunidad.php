...
<li class="dropdown">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                   ...
                   <li><a href="../Solicitudes/ingresar_solicitud_plan_desarrollo.php">
                   <i class="icon-plus"></i> Ingresar Solicitud Plan Desarrollo</a></li>

                   <li><a href="../Solicitudes/listado_solicitud_plan_desarrollo.php">
                   <i class="icon-list"></i> Listado Solicitud Plan Desarrollo</a></li>

                  <li role="presentation"><a role="menuitem" tabindex="-1" href="ingresar_solicitud_comunidad.php"><i class="icon-plus"></i> Ingresar Solicitud de la Comunidad</a>

                    </li>

                    <li role="presentation"><a role="menuitem" tabindex="-1" href="listado_solicitud_comunidad.php"><i class="icon-list"></i> Listado Solicitud de la Comunidad</a>
...
-->
  ...
  <li><a href="#"><i class=""></i> ------------------Personal-----------------</a></li>
   <li><a href="../Crear/barrio.php"><i class="icon-plus"></i> Crear Barrio</a></li>
...
<li><a href="../Crear/inversion.php"><i class="icon-plus"></i>  Sector de Inversion </a></li>
                    <li><a href="../Crear/subsector.php"><i class="icon-plus"></i>  SUB-Sector de Inversion </a></li>
